...
def meta_weights_for_nano_model(
    *,
    output_dir: Path = Path("/Users/zhenyishen/Downloads/LLaMA"),
    ckpt_dir: Path = Path("/Users/zhenyishen/Downloads/LLaMA"),
    tokenizer_path: Path = Path("/Users/zhenyishen/Downloads/LLaMA/tokenizer.model"),
    model_size: str = "7B",
) -> None:
